...
@patch(
    "cde_orchestrator.adapters.agents.agent_selection_policy.AgentSelectionPolicy.suggest_agent",
    return_value=AgentType.COPILOT,
)
...
@patch(
    "cde_orchestrator.adapters.agents.agent_selection_policy.AgentSelectionPolicy.suggest_agent",
    side_effect=ValueError("No suitable agent"),
)
