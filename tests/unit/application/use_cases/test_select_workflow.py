...
from src.cde_orchestrator.application.use_cases.select_workflow import SelectWorkflowUseCase
...
def test_select_web_application_workflow(select_workflow_use_case: SelectWorkflowUseCase):
...
def test_select_data_processing_workflow(select_workflow_use_case: SelectWorkflowUseCase):
...
def test_select_default_workflow_for_no_match(select_workflow_use_case: SelectWorkflowUseCase):
    """Should return 'default' when no patterns match."""
    prompt = "I want to write some documentation."
    workflow_type = select_workflow_use_case.execute(prompt)
    assert workflow_type == "default"

def test_select_workflow_is_case_insensitive(select_workflow_use_case: SelectWorkflowUseCase):
