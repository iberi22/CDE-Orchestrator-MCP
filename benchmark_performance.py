...
def benchmark_rust_performance(
    ...
    print(f"🔍 Benchmarking Rust Scanner Performance")
    ...
    print(f"   Python overhead: {cold_elapsed - result1['performance']['analysis_time_ms']:7.1f}ms\n")
    ...
    for i in range(num_iterations):
        ...
        print(f"   Iteration {i+1}: {elapsed:7.1f}ms (Rust: {result['performance']['analysis_time_ms']:7.0f}ms)")
...
def main() -> None:
    ...
    results = {
        ...
        "rust": {
            ...
            "analysis_avg_ms": sum(rust_times["analysis_times"]) / len(rust_times["analysis_times"]),
        },
        "python": {
            "avg_ms": python_avg,
