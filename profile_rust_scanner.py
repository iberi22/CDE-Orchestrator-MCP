...
def profile_rust_scanner() -> None:
    ...
    excluded_dirs = [
        ...
        ".ruff_cache", ".mypy_cache", "build", "dist", "htmlcov"
    ]
    ...
    if analysis_time > 1000:
        ...
        print(f"  1. Use incremental scanning (cache previous results)")
        print(f"  2. Reduce thread pool for smaller projects")
        print(f"  3. Pre-compile gitignore patterns")
        print(f"  4. Use memory-mapped I/O for large projects")
