...
def save_bedrock_config(config_dir: Path) -> tuple[Path, Path]:
    ...
    print(f"\n✅ Configuración Claude Code guardada: {claude_config_path}")
    ...
    print(f"✅ Configuración Aider guardada: {aider_config_path}")
...
"""
    ...
    print(f"\n✅ Variables de entorno guardadas: {env_path}")
...
def main() -> int:
    ...
    print("\n" + "=" * 70)
    print("✅ BEDROCK SETUP COMPLETADO")
    print("=" * 70)
    print("\n📋 Próximos pasos:")
    print("   1. Claude Code:")
